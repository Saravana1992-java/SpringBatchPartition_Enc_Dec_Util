...
@XmlRootElement(name = "insuredMailingAddres")
@XmlAccessorType (XmlAccessType.FIELD)

public class InsuredMailingAddress {
	...
	public String toString() {
		return "InsuredMailingAddress [addressLineOne=" + addressLineOne + ", addressLineTwo=" + addressLineTwo
